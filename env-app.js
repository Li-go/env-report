...
govmap.geocode({ keyword: firstAddress, type: govmap.geocodeType.AccuracyOnly }).then(function (response) {
                    ...
                    $.each(points, function (index, point) {
                        ...
                        govmap.getLayerData(params).then(function (response) {
                            ...
                            if ($.isEmptyObject(uniqueInstitutions) && radius === 3000) {
                                ...
                                $('body').prepend(noClinicsMessage); // Add the no clinics message at the top of the page
   ...
   govmap.geocode({keyword: (firstAddress), type: govmap.geocodeType.AccuracyOnly}
